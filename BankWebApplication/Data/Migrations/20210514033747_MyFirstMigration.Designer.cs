...
namespace BankWebbApp.Data.Migrations
{
    ...
    [Migration("20210514033747_MyFirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankWebbApp.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("BankWebbApp.Models.Card", b =>
                {
            ...
            modelBuilder.Entity("BankWebbApp.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("BankWebbApp.Models.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankWebbApp.Models.Loan", b =>
                {
            ...
            modelBuilder.Entity("BankWebbApp.Models.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("BankWebbApp.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("BankWebbApp.Models.User", b =>
                {
            ...
            modelBuilder.Entity("BankWebbApp.Models.Card", b =>
                {
                    b.HasOne("BankWebbApp.Models.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("BankWebbApp.Models.Disposition", b =>
                {
                    b.HasOne("BankWebbApp.Models.Account", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .HasConstraintName("FK_Dispositions_Accounts")
                        .IsRequired();

                    b.HasOne("BankWebbApp.Models.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("BankWebbApp.Models.Transaction", b =>
                {
                    b.HasOne("BankWebbApp.Models.Account", "AccountNavigation")
